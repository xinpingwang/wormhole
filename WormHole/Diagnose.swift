...
func diagnose() -> String {
    ...
    strs.append("-----------------------------------\n")
    strs.append("$ ls -l ~/Library/Application Support/WormHole/\n")
    strs.append(shell("ls", "-l", NSHomeDirectory() + "/Library/Application Support/WormHole/"))
    strs.append("-----------------------------------\n")
    strs.append("$ ls -l ~/Library/LaunchAgents/\n")
    strs.append(shell("ls", "-l", NSHomeDirectory() + "/Library/LaunchAgents/"))
    strs.append("-----------------------------------\n")
    strs.append("$ ls -l ~/.WormHole/\n")
    strs.append(shell("ls", "-l", NSHomeDirectory() + "/.WormHole/"))
    strs.append("-----------------------------------\n")
    strs.append("$ ls -l /Library/Application Support/WormHole/\n")
    strs.append(shell("ls", "-l", "/Library/Application Support/WormHole/"))
    strs.append("-----------------------------------\n")
    ...
    strs.append("-----------------------------------\n")
    strs.append("$ launchctl list | grep com.magicdone.wormhole\n")
    strs.append(shell("bash", "-c", "launchctl list | grep com.magicdone.wormhole"))
    strs.append("-----------------------------------\n")
