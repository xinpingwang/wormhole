...
let KCPTUN_CLIENT_VERSION = "v20191127"
let V2RAY_PLUGIN_VERSION = "1.2.0"
let PRIVOXY_VERSION = "3.0.26.static"
let SIMPLE_OBFS_VERSION = "0.0.5_1"
let APP_SUPPORT_DIR = "/Library/Application Support/WormHole/"
let USER_CONFIG_DIR = "/.WormHole/"
let LAUNCH_AGENT_DIR = "/Library/LaunchAgents/"
let LAUNCH_AGENT_CONF_SSLOCAL_NAME = "com.magicdone.wormhole.local.plist"
let LAUNCH_AGENT_CONF_PRIVOXY_NAME = "com.magicdone.wormhole.http.plist"
let LAUNCH_AGENT_CONF_KCPTUN_NAME = "com.magicdone.wormhole.kcptun.plist"
...
func generateSSLocalLauchAgentPlist() -> Bool {
    ...
    let dict: NSMutableDictionary = [
        "Label": "com.magicdone.wormhole.local",
...
func generatePrivoxyLauchAgentPlist() -> Bool {
    ...
    // For a complete listing of the keys, see the launchd.plist manual page.
    let dict: NSMutableDictionary = [
        "Label": "com.magicdone.wormhole.http",
        "WorkingDirectory": NSHomeDirectory() + APP_SUPPORT_DIR,
        "StandardOutPath": logFilePath,
        "StandardErrorPath": logFilePath,
        "ProgramArguments": arguments
